...
# Ajout des classes si elles n'existent pas
    ...
    if check is None:
        cursor.execute("INSERT INTO classes(name,spell1, spell2, ultimate) VALUES(?, ?, ?, ?)",
                       ("Mage", "Boule de feu", "Gel", "Météore"))
        cursor.execute("INSERT INTO classes(name,spell1, spell2, ultimate) VALUES(?, ?, ?, ?)",
                       ("Chevalier", "Bouclier", "Charge", "Coup de grâce"))
        cursor.execute("INSERT INTO classes(name,spell1, spell2, ultimate) VALUES(?, ?, ?, ?)",
                       ("Assassin", "Invisibilité", "Poison", "Assassinat"))
        cursor.execute("INSERT INTO classes(name,spell1, spell2, ultimate) VALUES(?, ?, ?, ?)",
                       ("Archer", "Flèche", "Flèche empoisonnée", "Flèche explosive"))
